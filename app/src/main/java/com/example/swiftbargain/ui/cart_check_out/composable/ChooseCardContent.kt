...
fun ChooseCardContent(
    ...
    ContentLoading(isVisible = state.chooseCardContentStatus == ContentStatus.LOADING)
    ContentVisibility(isVisible = state.chooseCardContentStatus == ContentStatus.VISIBLE) {
    ...
    ContentError(
        isVisible = state.chooseCardContentStatus == ContentStatus.FAILURE,
        onTryAgain = interactions::checkOutOder
    )
}
